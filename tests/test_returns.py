    ...
    def test_stats(self):
        ...
        pd.testing.assert_series_equal(
            ...
            pd.Series([
                ...
                pd.Timedelta('5 days 00:00:00'), 106.66666666666667, 2.0132218763525268e+65,
                ...
                1.9693400167084374, 7.094210421432714e+63, -0.2291666666666667
            ],
                index=stats_index,
                name='agg_func_mean'
            )
        ...
        pd.testing.assert_series_equal(
            ...
            pd.Series([
                pd.Timestamp('2018-01-01 00:00:00'), pd.Timestamp('2018-01-05 00:00:00'),
                pd.Timedelta('5 days 00:00:00'), 400.0, 6.03966562905758e+65, 641.7884083645566,
                np.nan, pd.NaT, 29.052280196490333, np.nan, np.inf, np.inf, 1.4693345482106241,
                2.030769230769236, 3.5238095238095237, 2.1282631264298142e+64, 0.26249999999999996
            ],
                index=stats_index,
                name='a'
            )
        ...
        pd.testing.assert_series_equal(
            ...
            pd.Series([
                pd.Timestamp('2018-01-01 00:00:00'), pd.Timestamp('2018-01-05 00:00:00'),
                pd.Timedelta('50 days 00:00:00'), 400.0, 312400.0, 150.23130314433288, np.nan, pd.NaT,
                6.800624405721308, np.nan, np.inf, np.inf, 1.4693345482106241, 2.030769230769236,
                3.5238095238095237, 11011.904761904761, 0.26249999999999996
            ],
                index=stats_index,
                name='a'
            )
        ...
        pd.testing.assert_series_equal(
            ...
            pd.Series([
                pd.Timestamp('2018-01-01 00:00:00'), pd.Timestamp('2018-01-05 00:00:00'),
                pd.Timedelta('5 days 00:00:00'), 400.0, 451.8597134178033, 6.03966562905758e+65,
                641.7884083645566, np.nan, pd.NaT, 29.052280196490333, np.nan, np.inf, np.inf,
                1.4693345482106241, 2.030769230769236, 3.5238095238095237, 2.1282631264298142e+64,
